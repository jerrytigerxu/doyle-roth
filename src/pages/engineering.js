...
export const query = graphql`
  query {
		one: file(relativePath: {eq: "Engineering/214_Fotolia_112503_X.jpg"}) {
      childImageSharp {
        fixed {
    ...
    two: file(relativePath: {eq: "Engineering/224_Tubehsheet_Edited.png"}) {
      childImageSharp {
        fixed {
          ...GatsbyImageSharpFixed
        }
    ...
    three: file(relativePath: {eq: "Engineering/234_Fotolia_1804440_X.jpg"}) {
      childImageSharp {
        fixed {
          ...GatsbyImageSharpFixed
        }
    ...
    four: file(relativePath: {eq: "Engineering/730_Overlay_Exchanger.png"}) {
      childImageSharp {
        fixed {
          ...GatsbyImageSharpFixed
        }
                ...
                <article className="media">
                  <div className="media-content">
                    <div className="content">
                      ...
                      <Img fixed={data.one.childImageSharp.fixed} alt="thermal"/>
                ...
                <article className="media">
                  <div className="media-content">
                    <div className="content">
                      ...
                      <Img fixed={data.two.childImageSharp.fixed} alt="mechanical"/>
                ...
                <article className="media">
                  <div className="media-content">
                    <div className="content">
                      ...
                      <Img fixed={data.three.childImageSharp.fixed} alt="quotation"/>
                      <p className="subtitle is-size-5">
                ...
                <article className="media">
                  <div className="media-content">
                    <div className="content">
                      ...
                      <Img fixed={data.four.childImageSharp.fixed} alt="3d"/>
                      <p className="subtitle is-size-5">
